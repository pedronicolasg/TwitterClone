...
<body class="bg-white dark:bg-black text-black dark:text-white min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg">
            <h1 class="text-2xl font-bold mb-8 text-center">Sign in to Twitter</h1>
            <form method="POST" action="methods/handlers/login.php" class="space-y-6">
                <div>
            ...
            <div class="text-center">
                ...
                <a href="signup.php" class="text-blue-500 hover:text-blue-600 ml-1">
                    Sign up
                </a>
            </div>
        </div>
